...
def handle_callback(call):
    ...
    # Kanallarni tanlash
        ...
        for channel in channels:
            ...
            btn = types.InlineKeyboardButton(btn_text, callback_data=f"toggle_{post_id}_{channel['id']}")
            markup.add(btn)
        
        btn_done = types.InlineKeyboardButton("✅ Tayyor - Yuborish", callback_data=f"confirm_{post_id}")
        btn_back = types.InlineKeyboardButton("⬅️ Bekor qilish", callback_data=f"cancelsend_{post_id}")
